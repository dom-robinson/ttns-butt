...
| **Remote dial-in** | [`docs/REMOTE_DIALIN.md`](docs/REMOTE_DIALIN.md) |
...
Tag **`v0.1.16-ttns-remote.3`** — standalone **Deck** and **Remote** installers for Mac, Windows, and Linux.

Older mixer-only freeze: **`v0.1.16-ttns-pre.7`**.

```bash
git checkout v0.1.16-ttns-remote.3
